...
\begin{tabular}{|p{0.30\textwidth}|p{0.22\textwidth}|p{0.34\textwidth}|}
  ...
  \hline
  Automated test cases & All pass & 51 of 51 passed (100\% pass rate) \\
  \hline
  Test files & All pass & 5 of 5 passed \\
  \hline
...
report, all 51 automated tests passed, all 39 production source files were
